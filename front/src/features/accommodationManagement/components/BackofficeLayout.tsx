...
const LISTING_GATED_ROUTES = ['/admin/accommodations', '/admin/calendar', '/admin/reservations', '/admin/revenue'];
...
const HOST_MENU: MenuItem[] = [
  ...
  {
    to: '/admin/revenue',
    labelKey: 'backoffice.menu.revenue',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const BackofficeLayout: React.FC = () => {
  ...
  // Load the traveler's reservations so the menu can flag stays that can still be rated.
  useEffect(() => {
    if (isTraveler) {

...
/**
 * @implements ProcessorInterface<AdminSolidarityProjectStatusInput, void>
 */
final readonly class SetSolidarityProjectStatusProcessor implements ProcessorInterface
{
    ...
    {
        if (!$data instanceof AdminSolidarityProjectStatusInput) {
            throw new \InvalidArgumentException(\sprintf('Expected "%s", got "%s".', AdminSolidarityProjectStatusInput::class, get_debug_type($data)));
        }
        ...
        $this->handler->execute(fn () => $this->useCase->handle(new SetSolidarityProjectStatusCommand(

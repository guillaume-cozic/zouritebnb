 ...
 */
final readonly class ApproveReservationModificationProcessor implements ProcessorInterface
{
    public function __construct(
        private ApproveReservationModification $approveModification,
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): ReservationOutput
    {
        ...
        $this->handler->execute(fn () => $this->approveModification->handle(new ApproveReservationModificationCommand(reservationId: $id)));

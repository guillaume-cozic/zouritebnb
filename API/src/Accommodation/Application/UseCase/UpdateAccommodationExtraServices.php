...
final readonly class UpdateAccommodationExtraServices
{
    ...
    public function handle(UpdateAccommodationExtraServicesCommand $command): void
    {
        ...
        $accommodation->updateExtraServices(ExtraServices::fromArray($command->extraServices));

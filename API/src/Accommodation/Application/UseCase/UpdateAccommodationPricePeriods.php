...
final readonly class UpdateAccommodationPricePeriods
{
    ...
    public function handle(UpdateAccommodationPricePeriodsCommand $command): void
    {
        ...
        $accommodation->updatePricePeriods(PricePeriods::fromArray($command->pricePeriods));
